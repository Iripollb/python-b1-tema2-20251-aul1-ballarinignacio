...
def tax_calculation_group_1(value: int): #se indica que value es un entero
    # Write here your code
    tax_percent = 19 #variable tax_percent asiganada al 19% 
    return (value * tax_percent) / 100   # se calcula el resultado 
